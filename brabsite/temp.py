...
The TemporaryFile-class (core/files/temp.py), is missing the 'closed'-attribute.
It inherits from FileProxyMixin, but this class also doesn't have a closed-attribute.
Thus patched.The patch adds the property with the expected behavior.

2: https://code.djangoproject.com/ticket/11857
